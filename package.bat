...
7z rn Lua_%1.zip Bin\Release%1\Lua.exe Lua.exe Bin\Release%1\Lua.dll Lua.dll Bin\Release%1\lfs.dll lfs.dll Bin\Release%1\lrwin32.dll lrwin32.dll > NUL || exit /b 1
