...
rem zip -j Lua_%1.zip Bin\Release%1\Lua.exe Bin\Release%1\Lua54.dll Bin\Release%1\lfs.dll || exit /b 1
...
7z a Lua_%1.zip Bin\Release%1\Lua.exe Bin\Release%1\Lua54.dll Bin\Release%1\lfs.dll register.bat > NUL || exit /b 1
7z rn Lua_%1.zip Bin\Release%1\Lua.exe Lua.exe Bin\Release%1\Lua54.dll Lua54.dll Bin\Release%1\lfs.dll lfs.dll > NUL || exit /b 1
