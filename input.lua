...
hConsoleInput = check(w.CreateFile("CONIN$", w.Access.GENERIC_READ, w.FileShare.READ, nil, w.Creation.OPEN_EXISTING, w.FileAttribute.NORMAL, w.NULL), "Error opening CONIN$")
hConsoleOutput = check(w.CreateFile("CONOUT$", w.Access.GENERIC_WRITE, w.FileShare.WRITE    , nil, w.Creation.OPEN_EXISTING, w.FileAttribute.NORMAL, w.NULL), "Error opening CONOUT$")
...
success, msg = w.ReadConsole(hConsoleInput, 1024, default, inputcontrol)
